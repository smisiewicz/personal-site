        ...
        <div className="items-center">
            <div className="flex justify-center space-x-6">
                <div className="space-y-5">
                    <h1 className="text-6xl font-bold text-lightgray mb-10">Hi there!</h1>

                    <div className="flex">
                        <h3 className="text-3xl font-extrabold text-primary tracking-wide flex-wrap">
                            <span className="font-normal text-lightgray mr-3">I am</span>
                            <span className="inline-block mr-3 uppercase">Sebastian</span>
                            <span className="uppercase">Misiewicz</span>
                            <span className="font-normal text-lightgray ml-1">.</span>
                        </h3>
                    </div>
            ...
            <div className="flex justify-center">
                <div className="max-w-5xl bg-darkcard text-lightgray p-6 rounded-lg shadow-lg font-light mt-14 md:mt-10">
                    <div className="mb-4">
                        <p>
                            ...
                            development for <b className="text-secondary">Android</b>,{' '}
                            <b className="text-secondary">iOS</b>, and <b className="text-secondary">macOS</b>, as well
                            as creating dynamic and responsive web applications.
                        </p>
                    </div>
                    <div className="mb-4">
                        I have a strong background in building and deploying{' '}
                        <b className="text-secondary">React Native</b> apps that work seamlessly across multiple
            ...
            <div className="flex justify-center space-x-10 mt-10">
                <a
                    className="p-5 rounded-full bg-darkcard hover:text-primary text-lightgray transition-all duration-300"
